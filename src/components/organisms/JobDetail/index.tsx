        ...
        <div className="col-span-2 space-y-10">
          <div>
            ...
            <div className="text-gray-500 mt-3">
              ...
              laborum enim voluptates quos exercitationem suscipit ex cupiditate
              in sed omnis totam voluptas est provident consequatur minus
              excepturi, unde voluptatum ducimus.
            </div>
          </div>
          <div>
